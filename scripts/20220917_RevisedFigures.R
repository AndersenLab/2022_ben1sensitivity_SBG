...
Fig1A <- cowplot::ggdraw()+ cowplot::draw_image("20220715_Fig1.png")
Fig1 <- cowplot::plot_grid(Fig1A, nrow = 1)
ggplot2::ggsave("fig1.jpeg", plot=Fig1, width = 3.75, height = 3)


#Figure2

Fig2A <- cowplot::ggdraw()+ cowplot::draw_image("20220714_Figure2A.png")
Fig2B <- cowplot::ggdraw()+ cowplot::draw_image("20220718_Fig2B.png")
...
GFP_dist <-norm_green %>%
  ...
  ggplot2::ggplot()+
    ...
    ylab("Density")+
    ylim(0,6)+
    geom_text(x=0.15,y=5.5,label="GFP-", size=4)+
    geom_text(aes(x=1.75,y=1.75),label="GFP+", size=4)+
...
regressed <- easysorter::regress(outlierpruned_tissue)
...
ggplot2::ggsave("fig3.jpeg", fig3, width = 7.5, height = 4.3, units = "in" )
